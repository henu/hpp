...
"			vec3 tspace_tangent = normalize(mvpmat * vec4(tangent.xyz, 0.0));\n"
"			vec3 tspace_binormal = normalize(mvpmat * vec4(binormal.xyz, 0.0));\n"
"			vec3 tspace_normal = normalize(mvpmat * vec4(normal.xyz, 0.0));\n"
"\n"
