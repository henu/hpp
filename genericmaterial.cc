...
"		#endif\n"
"\n"
"		light_pos_w = light_pos_viewspace.w;\n"
"\n"
"	#endif\n"
"\n"
"}\n";
...
"#endif\n"
"\n"
"#ifdef WEIGHTED_NORMALS\n"
"uniform float normal_weight;\n"
"#endif\n"
"\n"
"#ifdef SHADOW_FUNC\n"
"varying vec4 frag_pos;\n"
...
"\n"
"	#ifdef COLOR\n"
"	vec4 color = vec4(material_color.xyz, 1.0);\n"
"	#else\n"
...
"			#ifdef NMAP\n"
"					#ifdef WEIGHTED_NORMALS\n"
"						light_diffuse *= 1.0 - normal_weight + normal_weight * max(dot(frag_normal, normalize(light_pos_tspace)), 0.0);\n"
"					#else\n"
"						light_diffuse *= max(dot(frag_normal, normalize(light_pos_tspace)), 0.0);\n"
"					#endif\n"
"				if (light_pos_w > 0.5) light_diffuse_distance = length(light_pos_tspace);\n"
"			#else\n"
"// TODO: Try to use tangentspace?\n"
"				#ifndef ZERO_WEIGHTED_NORMALS\n"
"					#ifdef WEIGHTED_NORMALS\n"
"						light_diffuse *= 1.0 - normal_weight + normal_weight * max(dot(frag_normal, light_pos_vertexspace_nrmz), 0.0);\n"
"					#else\n"
"						light_diffuse *= max(dot(frag_normal, light_pos_vertexspace_nrmz), 0.0);\n"
"					#endif\n"
"				#endif\n"
"				if (light_pos_w > 0.5) light_diffuse_distance = light_pos_vertexspace_len;\n"
"			#endif\n"
"\n"
"			if (light_pos_w > 0.5) {\n"
...
"			light_diffuse *= (1.0 - shadow_amount);\n"
"			#endif\n"
"\n"
"			light += light_diffuse;\n"
"		#endif\n"
...
"\n"
"	#ifdef COLOR\n"
"	gl_FragColor.w *= material_color.w;\n"
"	#endif\n"
"\n"
"}\n";
...
"	#ifdef ROUND_ALPHA\n"
"	if (color.w > 0.5) {\n"
"		final_color = vec4(color.xyz * light, 1.0);\n"
"	} else {\n"
"		discard;\n"
"	}\n"
"	#else\n"
...
"\n"
"	#ifdef COLOR\n"
"	final_color.w *= material_color.w;\n"
"	#endif\n"
"\n"
"}\n";

float const GenericMaterial::ZERO_THRESHOLD = 0.005;
float const GenericMaterial::ONE_THRESHOLD = 0.995;
...
void GenericMaterial::initShaders(void)
{
	...
	uniformnames.push_back("normal_weight");
